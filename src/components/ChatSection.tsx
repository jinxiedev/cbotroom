...
export function ChatSection({ user, onAuthClick }: ChatSectionProps) {
  ...
  useEffect(() => {
    if (user) {
      ...
      // User is logged out, clear messages
      setMessages([]);
          ...
          >
            {!user ? (
              <div className="text-center py-12">
                ...
                <button
                  onClick={onAuthClick}
                  className="bg-slate-700 hover:bg-slate-600 text-white px-6 py-3 rounded-lg font-medium transition-all duration-200"
                >
                  Sign In / Sign Up
                </button>
              </div>
