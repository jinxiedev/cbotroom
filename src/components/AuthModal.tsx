        ...
        <div className="relative p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 transition-all duration-200 placeholder-slate-500 text-white font-mono"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 bg-slate-800/50 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 transition-all duration-200 placeholder-slate-500 text-white font-mono"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-slate-700 text-white font-medium rounded-xl hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-slate-500/50 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed font-mono"
            >
              {loading ? (
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-400 font-mono">
              ...
              <button
                onClick={switchMode}
                className="ml-2 text-slate-400 hover:text-slate-300 font-medium transition-colors"
              >
