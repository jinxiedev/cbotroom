      ...
      <div className="max-w-4xl mx-auto text-left relative z-20">
        <div className="bg-black/20 backdrop-blur-xl rounded-3xl border border-slate-800/50 p-12">
          ...
          <div className="space-y-6 text-lg text-slate-300 leading-relaxed">
            ...
            <p>
              Powered by <span className="text-white font-medium">Jinshi high-performance AI models</span> including 
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-800/30 rounded-xl p-6 border border-slate-700/50">
              <div className="w-12 h-12 bg-slate-700/20 rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-white font-semibold mb-2">Fast Performance</h3>
              <p className="text-slate-400 text-sm">Optimized for speed with Jinshi lightning-fast inference</p>
            </div>
